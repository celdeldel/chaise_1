...
## general settings.
parser.add_argument('--train_data_root', type=str, default='workbitch/chaise_0/pggan/chaise_0')
...
##add arguments to take a pretrained model
parser.add_argument('--start_res', type=int, default=2)
parser.add_argument('--checkpoint_generator', type=str, default="gen_R7_T3550.pth.tar")
parser.add_argument('--checkpoint_discriminator', type=str, default="dis_R7_T3550.pth.tar")
